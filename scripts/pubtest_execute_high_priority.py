...
def _write_determinism(proof_dir: Path) -> Path:
    repeat_path = ROOT / ".agent/sprints/2026-05-27-m7-daily-pipeline-integration/repeatability.json"
    restart_path = ROOT / ".agent/sprints/2026-05-27-m7-restart-continuity/restart_continuity.json"
...
def _write_canary(proof_dir: Path) -> list[Path]:
    ...
    skill_path = ROOT / ".agent/sprints/2026-05-27-m7-honest-speedup-skill-diff/gpu_vs_cpu_skill_diff.json"
