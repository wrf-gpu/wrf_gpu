...
GEN2_ENV = Path("<USER_HOME>/src/canairy_meteo/Gen2/artifacts/wrf_gpu_src/env_wrf_gpu.sh")
GEN2_WRF = Path("<USER_HOME>/src/canairy_meteo/Gen2/artifacts/wrf_gpu_src/WRF")
