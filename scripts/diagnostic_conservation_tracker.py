...
Source citations: `.agent/milestones/ROADMAP.md:78-88` names M4 invariants,
and `.agent/milestones/ROADMAP.md:89-98` carries those checks into M6.
"""
...
def build_payload(input_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "source_citations": [".agent/milestones/ROADMAP.md:78-88", ".agent/milestones/ROADMAP.md:89-98"],
    }
