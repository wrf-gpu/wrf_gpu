...
pass
sys.path.insert(0,"<USER_HOME>/src/wrf_gpu2/src")
import numpy as np
...
sys.argv=["x"]
sys.path.insert(0,"<USER_HOME>/src/wrf_gpu2/scripts"); from d03_replay import build_l3_d03_daily_case
cfg=DailyPipelineConfig(run_id="20260521_18z_l3_24h_20260522T133443Z",hours=24,
    ...
    run_root=Path("<DATA_ROOT>/canairy_meteo/runs/wrf_l3"),score=False,domain="d03",
...
c=Dataset("<DATA_ROOT>/canairy_meteo/runs/wrf_l3/20260521_18z_l3_24h_20260522T133443Z/wrfout_d03_2026-05-21_18:00:00")
def f(ds,n):
