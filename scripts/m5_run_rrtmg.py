...
# Canonical regenerator for the committed m5 RRTMG proof artifacts: opt in to the
# proof-write gate so run_tier1_*/run_tier2 dump to the tracked paths (the pytest
# suite leaves the flag unset and does not re-dirty them).
