...
DEFAULT_ROOTS = [
    "<DATA_ROOT>/canairy_meteo/runs/wrf_l2",
    "<DATA_ROOT>/canairy_meteo/runs/wrf_l2_backfill_output",
    "<DATA_ROOT>/canairy_meteo/runs/wrf_l3",
    "<DATA_ROOT>/canairy_meteo/runs/campaign_l2",
    "<DATA_ROOT>/canairy_meteo/runs/campaign_l3",
    "<DATA_ROOT>/canairy_meteo/runs/forcing_cases",
    "<DATA_ROOT>/canairy_meteo/runs/wps_cases",
    "<DATA_ROOT>/canairy_meteo/runs/surface_geo_v2_1",
    "<DATA_ROOT>/canairy_meteo/runs/phys_sweep",
    "<DATA_ROOT>/canairy_meteo/runs/terrain_sweep",
    "<DATA_ROOT>/canairy_meteo/runs/cu0_confirm",
    "<DATA_ROOT>/canairy_meteo/gate_2way_d02_v013",
    "<DATA_ROOT>/canairy_meteo/gate_2way_v013",
    "<DATA_ROOT>/canairy_meteo/gate_2way_v013c",
    "<DATA_ROOT>/canairy_meteo/gate_gwd_nested_v013b",
    "<DATA_ROOT>/canairy_meteo/gate_revalidate_gwd8",
    "<DATA_ROOT>/canairy_meteo/gen2_archive/teacher_l3",
