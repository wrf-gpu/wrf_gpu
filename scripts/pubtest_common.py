...
SPRINT_DIR = ROOT / "proofs" / "generated" / "2026-05-27-testing-plan-execution"
WRF_SOURCE = Path(os.environ.get("WRF_GPU_WRF_SOURCE", str(reference_path("artifacts", "wrf_gpu_src", "WRF"))))
WRF_ENV = Path(os.environ.get("WRF_GPU_ENV", str(reference_path("artifacts", "wrf_gpu_src", "env_wrf_gpu.sh"))))
STABLE_WRF_EXE = Path(os.environ.get("WRF_GPU_STABLE_WRF_EXE", str(ROOT / "builds" / "stable_20260509T213321Z" / "wrf.exe")))
CANARY_RUN_ROOT = reference_path("runs", "wrf_l3")
