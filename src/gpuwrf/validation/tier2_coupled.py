...
- Dry-column mass and mass-coupled advection follow WRF EM's RK prep path:
  `<reference-data-root>/artifacts/wrf_gpu_src/WRF/dyn_em/module_em.F:141-151`
...
- Water budget diagnostics follow WRF's diagnostic driver call carrying
  ...
  `<reference-data-root>/artifacts/wrf_gpu_src/WRF/phys/module_diagnostics_driver.F:336-356`.
"""
