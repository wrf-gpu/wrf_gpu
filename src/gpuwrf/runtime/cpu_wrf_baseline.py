...
SPRINT = ROOT / "proofs" / "generated" / "2026-05-25-m6-perf-design-acceptance"
ARTIFACTS = SPRINT / "artifacts"
DEFAULT_RUN_ID = "20260521_18z_l3_24h_20260522T072630Z"
DEFAULT_RUN_ROOT = reference_path("runs", "wrf_l3")
DEFAULT_WRF_EXE = Path(os.environ.get("WRF_GPU_STABLE_WRF_EXE", "builds/stable_20260509T213321Z/wrf.exe"))
DEFAULT_MPIRUN = reference_path("artifacts", "nvhpc", "Linux_x86_64", "26.3", "comm_libs", "hpcx", "bin", "mpirun")
CPU_CORES = "4-31"
CPU_RANKS = 28
