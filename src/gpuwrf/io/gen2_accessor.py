...
from gpuwrf.paths import reference_path, reference_root


GEN2_READ_ONLY_ROOT = reference_root()
DEFAULT_M6_GEN2_RUN_DIR = reference_path("runs", "wrf_l3", "20260521_18z_l3_24h_20260522T133443Z")
...
class Gen2Run:
    ...
    def build_manifest(self, *, include_sha256: bool = True) -> dict[str, Any]:
        ...
        return {
            ...
            "source_citations": [
                "<development-history-not-included-in-public-repo>/cpu-wrf-baseline.md",
                str(self.path / "namelist.input"),
                "<development-history-not-included-in-public-repo>/wrf-gpu.md",
            ],
        }
