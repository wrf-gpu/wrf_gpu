#!/usr/bin/env python
"""Run the mass-budget publication wrapper."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--boundary-flux-corrected", action="store_true")
    parser.add_argument("--output", type=Path, default=SPRINT_DIR / "conservation_mass_24h.json")
