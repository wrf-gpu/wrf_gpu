...
| tables/performance_summary.md | pre-fix / post-fix split | revision-pass `6f97743` |
| tables/skill_regression_summary.md | pre-fix / iter-1 split — needs iter-2 row | revision-pass `6f97743` |
| tables/comparators.md | pending — benchmark/tables consolidation sprint | — |
| tables/m7_gates.md | pending — benchmark/tables consolidation sprint | — |
| figures/timeline.md | pending — benchmark/tables consolidation sprint | — |
| figures/role_taxonomy.md | pending — benchmark/tables consolidation sprint | — |
