...
The brief-derived comparator rows used for this related-work framing are staged in `tables/comparators.md`.
...
Proof objects were ordinary files: JSON measurements, Markdown verdicts, logs, and reports. They were not replaced by chat summaries. Examples used here include `proofs/2026-05-27-m7-honest-speedup-skill-diff__honest_speedup_table.json`, `proofs/2026-05-27-m7-honest-speedup-skill-diff__gpu_vs_cpu_skill_diff.json`, `proofs/2026-05-27-m7-profiler-window-fix__d2h_audit_v2.json`, `proofs/2026-05-27-m7-restart-continuity__restart_continuity.json`, `proofs/2026-05-27-m7-1km-memory-audit__step_feasibility.json`, `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_speedup.json`, `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_skill_diff.json`, and `proofs/2026-05-27-m7-skill-fix-algorithmic__invariant_preservation.json`.
...
The consolidated pre-fix, iteration-1, and iteration-2 performance table is staged in `tables/performance_evolution.md`.

| System state | Claim | Value | Proof object |
|---|---|---:|---|
| Iteration-2 path (current headline) | 24 h d02 pipeline wall time | 732.63 s | `proofs/2026-05-27-m7-skill-fix-iter2__pipeline_run_20260521.json` |
| Iteration-2 path (current headline) | 24 h forecast-only wall time | 687.90 s | `proofs/2026-05-27-m7-skill-fix-iter2__pipeline_run_20260521.json` |
| Iteration-2 path (current headline) | Apples-to-apples d02-only speedup | 22.26x | `proofs/2026-05-27-m7-skill-fix-iter2__post_iter2_speedup.json` |
| Iteration-1 path (predecessor) | 24 h d02 pipeline wall time | 708.32 s | `proofs/2026-05-27-m7-skill-fix-algorithmic__pipeline_run_20260521.json` |
| Iteration-1 path (predecessor) | 24 h forecast-only wall time | 700.73 s | `proofs/2026-05-27-m7-skill-fix-algorithmic__pipeline_run_20260521.json` |
| Iteration-1 path (predecessor) | CPU d02-only timing denominator | 16305 s | `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_speedup.json` |
| Iteration-1 path (predecessor) | Apples-to-apples d02-only speedup | 23.02x | `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_speedup.json` |
| Iteration-1 path (predecessor) | Full five-domain CPU aggregate framing | 63.39x, not apples-to-apples | `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_speedup.json` |
| Pre-fix diagnostic path | 24 h d02 pipeline wall time | 324.78 s | `proofs/2026-05-27-m7-daily-pipeline-integration__pipeline_run_20260521.json` |
| Pre-fix diagnostic path | 24 h forecast-only wall time | 310.27 s | `proofs/2026-05-27-m7-daily-pipeline-integration__pipeline_run_20260521.json` |
| Pre-fix diagnostic path | Apples-to-apples d02-only speedup | 50.20x | `proofs/2026-05-27-m7-honest-speedup-skill-diff__honest_speedup_table.json` |
| Pre-fix diagnostic path | Full five-domain CPU aggregate framing | 138.24x, not apples-to-apples | `proofs/2026-05-27-m7-honest-speedup-skill-diff__honest_speedup_table.json` |
| Shared systems evidence | Warm 1 h d02 forecast wall time | 5.71 s | `proofs/2026-05-26-m7-gpu-profile-prep__wall_clock.json` |
| Shared systems evidence | Three-run warm reproducibility CV | 0.42 percent | `proofs/2026-05-27-m7-profiler-window-fix__reproducibility_v2.json` |
| Shared systems evidence | Inter-kernel D2H inside forecast loop | 0 copies, 0 bytes | `proofs/2026-05-27-m7-profiler-window-fix__d2h_audit_v2.json` |
| Shared systems evidence | Restart continuity | max delta 0.0 | `proofs/2026-05-27-m7-restart-continuity__restart_continuity.json` |
| Shared systems evidence | Pipeline wrfout inventory | 24/24 files readable | `<development-history-not-included-in-public-repo>/2026-05-27-m7-daily-pipeline-integration/wrfout_inventory.json` |
| Shared systems evidence | 1 km one-step memory probe | 7278 MiB of 32607 MiB | `proofs/2026-05-27-m7-1km-memory-audit__step_feasibility.json` |
...
The full CPU, pre-fix GPU, iteration-1 GPU, and iteration-2 GPU BIAS/MAE/RMSE matrix is staged in `tables/skill_evolution.md`.
...
The full per-variable comparison is staged in `tables/skill_evolution.md`. The headline RMSE summary, comparing pre-fix, iteration-1, and iteration-2 GPU paths against the CPU WRF baseline, is:
...
- `<development-history-not-included-in-public-repo>/decisions/MILESTONE-M6-CLOSEOUT.md`
- `<development-history-not-included-in-public-repo>/decisions/MILESTONE-M7-CLOSEOUT-AMENDMENT.md`
- `proofs/2026-05-26-m7-gpu-profile-prep__wall_clock.json`
- `proofs/2026-05-27-m7-profiler-window-fix__reproducibility_v2.json`
- `proofs/2026-05-27-m7-profiler-window-fix__d2h_audit_v2.json`
- `proofs/2026-05-27-m7-daily-pipeline-integration__pipeline_run_20260521.json`
- `proofs/2026-05-27-m7-honest-speedup-skill-diff__honest_speedup_table.json`
- `proofs/2026-05-27-m7-honest-speedup-skill-diff__gpu_vs_cpu_skill_diff.json`
- `<development-history-not-included-in-public-repo>/2026-05-27-m7-l2-d02-replay-validation/tier4_rmse_l2_d02.json`
- `proofs/2026-05-27-m7-restart-continuity__restart_continuity.json`
- `proofs/2026-05-27-m7-1km-memory-audit__step_feasibility.json`
- `proofs/2026-05-27-m7-skill-fix-algorithmic__pipeline_run_20260521.json`
- `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_speedup.json`
- `proofs/2026-05-27-m7-skill-fix-algorithmic__post_fix_skill_diff.json`
- `proofs/2026-05-27-m7-skill-fix-algorithmic__invariant_preservation.json`
- `<development-history-not-included-in-public-repo>/2026-05-27-publication-revision-pass/revision_decisions.md`
- `paper/honesty_audit.md`
...
References will be rendered from `paper/references.bib` during LaTeX conversion.
