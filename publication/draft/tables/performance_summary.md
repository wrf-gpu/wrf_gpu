...
Table 1. Performance summary separated by system state. The iteration-2 path is the current manuscript result; earlier faster paths are retained only as diagnostic history.
...
| Iteration-1 predecessor | 24 h forecast-only wall time | 700.73 s | `.agent/sprints/2026-05-27-m7-skill-fix-algorithmic/pipeline_run_20260521.json` |
