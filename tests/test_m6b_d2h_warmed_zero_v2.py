...
``.agent/sprints/2026-05-25-m6b-d2h-warmed-recapture-v2/proof_nsys_transfers_inside_loop.json``
...
SPRINT = ROOT / ".agent" / "sprints" / "2026-05-25-m6b-d2h-warmed-recapture-v2"
