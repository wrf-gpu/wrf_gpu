...
PROOF = (
    ...
    / "2026-05-25-m6b-v3-localize-20260509-theta"
    / "proof_theta_explosion.json"
)

pytestmark = pytest.mark.skipif(not PROOF.exists(), reason="development-history proof not included in public repo")
