...
def test_v060_sfclay_revised_mm5_savepoint_parity_report() -> None:
    ...
    report = {
        ...
        "oracle": {
            ...
            "wrf_sources": [
                "<USER_HOME>/src/wrf_pristine/WRF/phys/module_sf_sfclayrev.F",
                "<USER_HOME>/src/wrf_pristine/WRF/phys/physics_mmm/sf_sfclayrev.F90",
                "<USER_HOME>/src/wrf_pristine/WRF/phys/ccpp_kind_types.f90",
            ],
