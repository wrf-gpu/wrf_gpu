...
def test_rrtmg_gate_accepts_carryforward_artifacts():
    ...
    assert record["gate_status"] == "GO_CARRYFORWARD"
    ...
    assert record["raw_hlo_launch_marker_count"] >= record["kernel_launches_per_step"]
