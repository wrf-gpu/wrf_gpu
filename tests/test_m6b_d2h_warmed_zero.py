...
SPRINT = ROOT / "<development-history-not-included-in-public-repo>" / "2026-05-25-m6b-d2h-warmed-recapture"
...
def test_warmed_capture_artifacts_present():
    ...
    assert WARMED.exists(), (
        ...
        f"<development-history-not-included-in-public-repo>/2026-05-25-m6b-d2h-warmed-recapture/proof_warmed.nsys-rep'"
    )
