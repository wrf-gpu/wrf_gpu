...
SAVEPOINT_ROOTS = (
    ROOT / ".agent/sprints/2026-05-24-m6b0r-real-fortran-emission/savepoints",
    Path("/tmp/wrf_gpu2_m6b0r/.agent/sprints/2026-05-24-m6b0r-real-fortran-emission/savepoints"),
)
