...
def test_adr_026_promoted_to_proposed():
    proposed = ROOT / "<development-history-not-included-in-public-repo>/decisions/ADR-026-operational-mode-design-PROPOSED.md"
    draft = ROOT / "<development-history-not-included-in-public-repo>/decisions/ADR-026-operational-mode-design-DRAFT.md"
