...
def test_interfaces_self_check_and_scheme_specs_cover_v060_options() -> None:
    assert_interfaces_consistent()
    # 27 single-option specs (8 microphysics incl. Purdue-Lin + WSM3/WSM5 + 5 PBL
    # incl. BouLac + 6 surface-layer incl. v0.13 Tier-3 GFS(3) + old-MM5(91) + 5
    # cumulus incl. BMJ cu=2 + 3 land-surface incl. v0.13 Tier-3 slab(1))
