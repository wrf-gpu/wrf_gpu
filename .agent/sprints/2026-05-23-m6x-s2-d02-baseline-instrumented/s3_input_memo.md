...
Proof cites:
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_sanitizer_audit.json`
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_limiter_activation_tracker.json`
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_stabilizer_provenance_scanner.json`
...
Proof cites:
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_vertical_column_phase_space.json`
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_operator_term_budget_tracer.json`
...
Proof cites:
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_field_rmse_timeline.json`
- `.agent/sprints/2026-05-23-m6x-s2-d02-baseline-instrumented/proof_operator_term_budget_tracer.json`
