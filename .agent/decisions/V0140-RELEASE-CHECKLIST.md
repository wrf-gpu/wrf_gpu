...
| Canary field parity | L2 d02 has retained CPU-WRF 72h truth: 15 complete cases in `/mnt/data/canairy_meteo/runs/wrf_l2_backfill_output`, each with 73 d02 frames. d03 retained truth is mainly 24h. | Mandatory Canary gate is L2 d02 72h CPU-vs-GPU field-parity/stability. d03/1 km is secondary after the two 72h release gates are green. |
...
3. Build/run or confirm matched CPU-WRF truth for both mandatory 72h gates:
   Switzerland/Gotthard d01 and Canary L2 d02.
