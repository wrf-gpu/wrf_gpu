...
| Canary field parity | L2 d02 has retained CPU-WRF 72h truth: 15 complete backfill cases in `/mnt/data/canairy_meteo/runs/wrf_l2_backfill_output`, each with 73 d02 frames. The selected gate case is `20260501_18z_l2_72h_20260519T173026Z`, because it is already the h1 field-falsifier case and has WRF `rc=0` backfill provenance. The post-EOS h1 adjudication verdict is `PROCEED_72H_GATES`. A detached Canary d02 72h GPU field-gate is running at `/mnt/data/wrf_gpu_validation/v014_canary_d02_72h_20260610T142426Z` with resource CSV logging. | Wait for `canary_d02_72h_gpu.rc`, `canary_d02_72h_compare.rc`, and `canary_d02_72h_atlas.rc`; if nonzero, inspect logs and escalate the exact failure. If green or bounded, commit proof artifacts and launch Switzerland GPU next. |
