...
6. Relaunch Canary L2 d02 72h GPU-vs-CPU field-parity/stability from the fixed
   ...
   h1 confirms dynamical/wind improvement but still has a `PSFC` residual;
   wait for h24/final and the parallel PSFC/vapor-light analysis before
   starting Switzerland GPU.
