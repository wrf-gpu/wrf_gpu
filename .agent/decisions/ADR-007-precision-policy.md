...
| Pressure-gradient accumulation | `FP64-locked` | FP64 only | Contract excludes revisiting pressure-gradient accumulation. | `.agent/sprints/2026-05-20-m5-adr007-precision-policy/sprint-contract.md:16`, `/home/enric/.claude/projects/-home-enric-src-wrf-gpu2/memory/feedback_validation_philosophy.md:21` |
...
| `state.w` / W wind | `needs-empirical-test` | Candidate FP32 only after sound-wave validation | Vertical velocity is acoustic-adjacent and has no physical sound-wave proof yet. | `.agent/decisions/MILESTONE-M4-CLOSEOUT.md:60`, `.agent/decisions/MILESTONE-M4-CLOSEOUT.md:65` |
