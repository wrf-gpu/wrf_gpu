...
- New raw WRF truth root: `<DATA_ROOT>/wrf_gpu2/v014_step1_qvapor_precall_savepoint/wrf_truth`.
- Filtered pre-call-only truth root for the next proof: `<DATA_ROOT>/wrf_gpu2/v014_step1_qvapor_precall_savepoint/precall_truth_only`.
- WRF patch diff artifact: `<USER_HOME>/src/wrf_gpu2/proofs/v014/step1_qvapor_precall_savepoint_wrf_patch.diff`.
