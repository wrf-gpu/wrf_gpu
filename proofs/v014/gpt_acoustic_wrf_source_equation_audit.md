...
This is an equation/source audit, not a new GPU proof. I did not edit source, run GPU, interact with Fable, use Hermes, or touch `/home/user/src/canairy_waves`.
...
```bash
nl -ba /home/user/src/wrf_pristine/WRF/dyn_em/module_big_step_utilities_em.F | sed -n '640,782p;1365,2178p'
nl -ba /home/user/src/wrf_pristine/WRF/dyn_em/module_small_step_em.F | sed -n '1178,1469p'
