...
| theta_prime_min_900s | -9.970995032353471 | -25 <= min(theta prime) <= -5 K | True |
| max_abs_w_900s | 14.574919073012929 | 1 <= max(|w|) <= 50 m/s | True |
| front_position_900s | 14150.0 | |front position - 15000 m| <= 2000 m | True |
| rotor_count_proxy_900s | 4.0 | 2 <= rotor proxy count <= 4 | True |
| relative_mass_drift | 2.2509470252373515e-09 | max relative dry-column mass drift <= 1e-8 | True |
...
- Plots: proofs/sprintU/close_gate/f2/plots/density_current_theta_prime_900s.ppm
