#!/usr/bin/env python3
"""Parse WSM7 flat oracle dumps into structured JSON savepoints."""
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        raise SystemExit("usage: wsm7_dump_to_json.py INFILE OUTFILE SCHEME")
