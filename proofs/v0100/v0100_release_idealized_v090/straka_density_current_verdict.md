...
| theta_prime_min_900s | -9.971054183170565 | -25 <= min(theta prime) <= -5 K | True |
| max_abs_w_900s | 14.575110003159276 | 1 <= max(|w|) <= 50 m/s | True |
...
- Plots: proofs/v0100/v0100_release_idealized_v090/plots/density_current_theta_prime_900s.ppm
