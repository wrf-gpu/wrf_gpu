#!/usr/bin/env python3
"""Parse the flat key=value dump from wdm7_oracle into a structured JSON savepoint.

Scalars: CASE, KX, DT, RAIN, RAINNCV, SNOW, SNOWNCV, GRAUPEL, GRAUPELNCV,
HAIL, HAILNCV, SR.
...
SCALARS = {"CASE", "KX", "DT", "RAIN", "RAINNCV", "SNOW", "SNOWNCV",
           "GRAUPEL", "GRAUPELNCV", "HAIL", "HAILNCV", "SR"}
