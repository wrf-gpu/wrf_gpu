...
| theta_prime_min_900s | -9.970995032353528 | -25 <= min(theta prime) <= -5 K | True |
| max_abs_w_900s | 14.574919073009728 | 1 <= max(|w|) <= 50 m/s | True |
...
- Plots: proofs/wind/idealized_postfix/plots/density_current_theta_prime_900s.ppm
