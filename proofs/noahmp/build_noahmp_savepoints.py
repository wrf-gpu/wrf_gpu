...
from gpuwrf.config.paths import wrf_root  # noqa: E402

# Pristine-WRF checkout root. Override with WRF_PRISTINE_ROOT; otherwise use
# GPUWRF_WRF_ROOT/config.paths.
WRF_PRISTINE_ROOT = Path(os.environ["WRF_PRISTINE_ROOT"]).expanduser() if os.environ.get("WRF_PRISTINE_ROOT") else wrf_root()
RUN = Path("<DATA_ROOT>/canairy_meteo/runs/wrf_l3/20260521_18z_l3_24h_20260522T133443Z")
