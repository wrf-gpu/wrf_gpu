...
| theta_prime_min_900s | -9.970995032354608 | -25 <= min(theta prime) <= -5 K | True |
| max_abs_w_900s | 14.574919073010726 | 1 <= max(|w|) <= 50 m/s | True |
| front_position_900s | 14150.0 | |front position - 15000 m| <= 2000 m | True |
| rotor_count_proxy_900s | 4.0 | 2 <= rotor proxy count <= 4 | True |
| relative_mass_drift | 2.250946885353438e-09 | max relative dry-column mass drift <= 1e-8 | True |
...
- Plots: proofs/p0_6/idealized_cpu/plots/density_current_theta_prime_900s.ppm
