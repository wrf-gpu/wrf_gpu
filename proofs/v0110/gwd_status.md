...
- WRF source:
  - `/home/enric/src/wrf_pristine/WRF/phys/module_pbl_driver.F:2225` calls `gwdo` only when `GWD_opt == 1`.
  - `/home/enric/src/wrf_pristine/WRF/dyn_em/module_first_rk_step_part1.F:1245` passes `config_flags%gwd_opt` and the `VAR/CON/OA/OL` fields into the PBL driver.
  - `/home/enric/src/wrf_pristine/WRF/share/input_wrf.F:751` checks nonzero namelist `gwd_opt` against each domain's `wrfinput` `GWD_OPT`.
  - `/home/enric/src/wrf_pristine/WRF/share/module_check_a_mundo.F:913` allows child domains to set `gwd_opt=0`.
- Corpus case: `/mnt/data/canairy_meteo/runs/wrf_l3/20260521_18z_l2rerun_l3_24h_20260522T231647Z`.
