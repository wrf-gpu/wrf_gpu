...
| theta_prime_max_500s | 1.9233937817783158 | 0.5 <= max(theta prime) <= 2.5 K | True |
| max_abs_w_500s | 11.676712060692958 | 1 <= max(|w|) <= 30 m/s | True |
| thermal_rise_500s | 1924.6850355806496 | positive-theta centroid rises by at least 500 m | True |
